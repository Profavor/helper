...
import com.favorsoft.schedule.job.EmailJob;
import com.favorsoft.schedule.model.ScheduleEmailRequest;
...
public class EmailJobSchedulerController {
    ...
    public ResponseEntity<ScheduleResponse> scheduleEmail(@Valid @RequestBody ScheduleEmailRequest scheduleEmailRequest) {
        try {
            ...
            ScheduleResponse scheduleEmailResponse = new ScheduleResponse(true,
